...
<div>
    ...
    <div className="container mx-auto py-10">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white p-4 shadow rounded">
          <h3 className="text-lg font-bold mb-2 text-gray-800">Ebook Writing</h3>
        ...
        <div className="bg-white p-4 shadow rounded">
          <h3 className="text-lg font-bold mb-2 text-gray-800">Caption Generator</h3>
          <p className="text-gray-700">
        ...
        <div className="bg-white p-4 shadow rounded">
          <h3 className="text-lg font-bold mb-2 text-gray-800">Blog Post Generator</h3>
          <p className="text-gray-700">
      ...
      <div className="bg-gray-50 py-10">
        <div className="container mx-auto px-5">
          <h2 className="text-5xl font-semibold text-gray-800 text-center mb-8">AI Writing Tool</h2>
          ...
          <div className="bg-white shadow-lg rounded-lg p-8 mx-auto max-w-3xl">
            <h3 className="text-2xl font-bold mb-4 text-gray-800">Subscription Plan</h3>
  ...
  <div className="mx-auto max-w-6xl text-center mt-10 bg-blue-600 py-10 text-white">
      ...
      <div className="mt-10">
        <form className="mx-auto max-w-md">
          <div className="flex flex-col mb-4">
            <label className="text-lg font-semibold text-gray-200 mb-2" htmlFor="inputText">Enter your text:</label>
            <textarea id="inputText" name="inputText" className="px-4 py-2 bg-gray-50 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" defaultValue={""} />
          </div>
          <div className="flex flex-col mb-4">
            <label className="text-lg font-semibold text-gray-200 mb-2" htmlFor="captionLength">Caption length:</label>
