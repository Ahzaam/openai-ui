  ...
  return (
    <div className="bg-gray-100 " style={{ minHeight: "70vh" }}>
      <div className="p-4 rounded-lg max-w-4xl mx-auto ">
        ...
        {outline.length > 0 && <div className={"p-4 rounded-lg text-center my-4 flex flex-col overflow-auto bg-white "
        }
          style={{ height: '66vh' }}>
          <h2 className="font-bold mb-2 text-2xl">AI Ebook Outline</h2>

          {outline.length > 0 && outline.map((el, ind) => {
            let reg = /^[ABCDEFGH-]{1}\.{0,1}/;
            
            if (reg.test(el.trim())) {
              return (
                <p className="text-gray-700 mb-4 text-justify pl-8" key={"outline-"+ind}>
                  {el}
                </p>
              )
            }
            ...
            return (
              <p className="text-gray-700 mb-4 text-justify underline font-semibold pl-4" key={"outline-"+ind}>
                {el}
              </p>
            )
          })}
        ...
        <div
          className={`p-4 rounded-lg text-center flex flex-col min-h-full bg-white ${processing || outline.length > 0 ? "fade-out" : "fade-in"
            }`}
  ...
  return (
    <div className="bg-gray-100 " style={{ minHeight: "70vh" }}>
      <div className="p-4 rounded-lg max-w-4xl mx-auto ">
        ...
        {chapters.length > 0 && <div className={"p-4 rounded-lg text-center my-4 flex flex-col overflow-auto bg-white "
        }
          style={{ height: '66vh' }}>
          <h2 className="font-bold mb-2 text-2xl">AI Ebook Chapter</h2>

          {chapters.length > 0 && chapters.map((el, ind) => {

            return (
              <div className="bg-white rounded-lg shadow-md p-4 mb-3" key={"chapter-"+ind}>
                ...
                <div className="text-right mt-2" onClick={(e) => {
                  ...
                  var text = document.querySelector("#chapterID-" + ind).textContent;
        ...
        <div
          className={`p-4 rounded-lg text-center flex flex-col min-h-full bg-white ${processing || chapters.length > 0 ? "fade-out" : "fade-in"
            }`}
          style={{ minHeight: "68vh" }}
        >
          <h2 className="font-bold mb-2 text-2xl">AI Ebook Outline</h2>
    ...
    >
      ...
      >
        <div className="bg-white rounded-lg shadow-md p-4 mb-3">
          ...
          <div className="flex items-center justify-between bg-gray-100 rounded-md p-3">
            <p className="text-gray-700">
              Navigate to "Wirte Outline" Tab and
              Generate Outline of the ebook you wish to generate by providing the Title of the ebook.
      ...
      >
        <div className="bg-white rounded-lg shadow-md p-4 mb-3">
          ...
          <div className="flex items-center justify-between bg-gray-100 rounded-md p-3">
            <p className="text-gray-700">
              Copy The title of a chapter appeared in the screen.
              Navigate to "Write Chapter" Tab and paste the title in the input and Generate the chapter.
              Repeat this step for all the chapters appeared in the outline.
      ...
      >
        <div className="bg-white rounded-lg shadow-md p-4 mb-3">
          ...
          <div className="flex items-center justify-between bg-[#fef08a] rounded-md p-3">
            <p className="text-gray-700">
              After generating a chapter please copy the text and save on your device.
              We do not keep track of your progress. Refreshing the page or Navigating to another page would result in losing your work.
